...
public final class EncryptUtil {
    ...
    public static String getSign(HashMap hashMap) {
        ...
        Iterator<Map.Entry<String, Object>> iter = hashMap.entrySet().iterator();
        while (iter.hasNext()) {
        ...
        for (int i = 0; i < keyList.size(); i++) {
            strs[i] = (String) keyList.get(i);
        }

        ArrayList list = SortUtils.sortASCII(strs);
